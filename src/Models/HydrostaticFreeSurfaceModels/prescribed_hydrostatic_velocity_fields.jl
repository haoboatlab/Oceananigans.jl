...
compute_w_from_continuity!(::PrescribedVelocityFields, args...; kwargs...) = NoneEvent()
...
calculate_hydrostatic_momentum_tendencies!(model, ::PrescribedVelocityFields, args...; kwargs...) = []
